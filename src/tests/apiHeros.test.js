...
let app = {}
const TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Ilh1eGFkYXNpbHZhIiwiaWQiOjEsImlhdCI6MTU0NzQxNzQ1MX0.3KcPkfF9OgmQgXEl7TLIugeSv8_vTJvsNeJDmLk32Ws'
...
describe('Suite de testes da API Herois', function() {
    ...
    it('atualizar PATCH - /herois/:id - não deve atualizar com id incorreto', async () => {
        const _id = `5c2a196cde105a02a4d81d56`
